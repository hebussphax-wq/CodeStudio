...
def main():
    ...
    candidates=[os.environ.get('CODESTUDIO_VSCODE')]
    ...
    state=pathlib.Path(os.environ.get('LOCALAPPDATA',str(pathlib.Path.home())))/'CodeStudio'/'VSCode'
    ...
    argv=[str(exe),'--new-window','--user-data-dir',str(state)]
